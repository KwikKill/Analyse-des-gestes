...
namespace Menus.CreateGesture.View
{
    ...
    public class CreateGestureView : CreateGestureElement
    {
        ...
        private void StartRecord()
        {
            ...
            isASequence.interactable = false;
        ...
        public void DisableClassNameInput(bool aSequence)
        {
            if (aSequence)
            {
                this.classNameField.interactable = false;
                classNameField.text = "Sequence";
            }
            else
                this.classNameField.interactable = true;
        }
    }
}