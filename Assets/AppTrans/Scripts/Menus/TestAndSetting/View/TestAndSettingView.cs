...
namespace Menus.TestAndSetting.View
{
    ...
    public class TestAndSettingView : TestAndSettingElement
    {
        ...
        public void InitView(StrategyRecognizer strategy,string theta, float curvi, List<Tuple<LeapMotionJointType,bool>> jointsStatus)
        {
            ...
            PanelSelectionJointure.SetActive(RecoManager.GetInstance().Device==DevicesInfos.Device.LeapMotion || RecoManager.GetInstance().Device==DevicesInfos.Device.SimulorLeapMotion);
            ...
            if(strategy!=null)
                ...
                StrategyNameText.text = "Not specified";
            UpdateStatus();
